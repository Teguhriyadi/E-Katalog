					...
					<div class="col-lg-3 col-md-6">
						<div class="">
							...
							<nav class="list-unstyled">
								<li class="list-space">
									<a href="home.blade.php" class="list-menu">Beranda</a>
								</li>
								<li class="list-space">
									<a href="katalog.blade.php" class="list-menu">Katalog</a>
								</li>
								<li class="list-space">
									<a href="" class="list-menu">Reader's Pick</a>
								</li>
								<li class="list-space">
									<a href="" class="list-menu">Pesanan</a>
								</li>
								<li class="list-space">
